        ...
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6 d-flex align-items-center">
                    <h1 class="m-0 mr-2">{{$pcategory->title}} </h1>
                    <a href="{{route('admin.pcategory.edit', $pcategory->id)}}" class="text-success"><i class="fas fa-pencil-alt"></i></a>
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">{{$pcategory->title}}</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
